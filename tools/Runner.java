    ...
    public void interactiveMode() {
        try {
            ...
            while (true) {
                ...
                if (commandStatus.message().equals("exit")) break;
                console.println(commandStatus.message());
            }
    ...
    private ExecutionResponse scriptMode(String argument) {
        ...
        try (Scanner scriptScanner = new Scanner(new File(argument))) {
            ...
            do {
                ...
                commandStatus = needLaunch ? launchCommand(userCommand) : new ExecutionResponse(false,"Превышена максимальная глубина рекурсии");
            ...
            } while (commandStatus.exitCode() && !commandStatus.message().equals("exit") && console.isCanReadln());
